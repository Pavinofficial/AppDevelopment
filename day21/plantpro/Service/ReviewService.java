...
public class ReviewService {
    ...
    public ResponseEntity<String> makeHttpRequest() {
        ResponseEntity<String> response = restTemplate.getForEntity("http://localhost:8181/api/feedback", String.class);
        return response;
    }

    public ResponseEntity<String> makeHttpPostRequest(Review review) {
        ResponseEntity<String> response = restTemplate.postForEntity("http://localhost:8181/api/feedback", review, String.class);
        return response;
    }
}
